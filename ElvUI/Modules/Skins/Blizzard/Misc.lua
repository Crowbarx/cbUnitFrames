...
local function LoadSkin()
	...
	for i = 1, UIDROPDOWNMENU_MAXBUTTONS do
		local chatMenuButton = _G["ChatMenuButton"..i]
		if chatMenuButton then E:StyleButton(chatMenuButton) end

		local emoteMenuButton = _G["EmoteMenuButton"..i]
		if emoteMenuButton then E:StyleButton(emoteMenuButton) end

		local languageMenuButton = _G["LanguageMenuButton"..i]
		if languageMenuButton then E:StyleButton(languageMenuButton) end

		local voiceMacroMenuButton = _G["VoiceMacroMenuButton"..i]
		if voiceMacroMenuButton then E:StyleButton(voiceMacroMenuButton) end
	end
